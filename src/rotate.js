  ...
  */
  setImage(result_reader) {
    ...
    img.onload = () => {
      ...
      const orientation = this.constructor.getOrientation(img);
      ...
      this.constructor.canvasResizeAndDrawImage(img, canvas, ctx);

      this.constructor.rotateFromOrientation(orientation, img, ctx, canvas);

      this.constructor.appendNewImage(canvas);
    }
